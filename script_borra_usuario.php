...
if(isset($id_empleado)){
    ...
    $nro_usuario_borrada_ap=$fila_nro_usuario['apellido'];
	...
	header("location:usuarios_por_confirmar.php?status=2&nombre=".$nro_usuario_borrada."&apellido=".$nro_usuario_borrada_ap."");
}else{
