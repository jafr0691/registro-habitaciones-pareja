    ...
    <div class="gt_sub_banner_bg default_width">
      <div class="container">
        <div class="gt_sub_banner_hdg  default_width">
          <h2>Modulo cambio de contraseña.</h2>
...
<div class="gt_wrapper">
    ...
    <font size="3" FACE="impact" COLOR=#FFFFFF >Se ha realizado el cambio de contraseña de forma exitosa.</font>
               </div>
    <?php } ?>
 ...
 <!-- MENSAJE WARNING-->
    ...
    <font size="3" FACE="impact" COLOR=#FFFFFF >Error: contraseña actual errónea.</font>
               </div>
    <?php } ?>
...
<?php 
    ...
    <font size="3" FACE="impact" COLOR=#FFFFFF >Alerta: Estas ingresando la contraseña actual.</font>
               </div>
    <?php } ?>

         <div class="gt_lgin_tab_wrap wow slideInUp">
          <ul class="gt_login_link" data-tabs="tabs">
              <li class="active" align="right"><a data-toggle="tab" style="border-color:#1e1744" >Cambiar&nbsp;</a></li>
              <li class="active" align="left"><a data-toggle="tab" style="border-color:#1e1744"> Contraseña</a></li>
            </ul>
            <?php include "formulario_cambio_contrasena.php"; ?>
