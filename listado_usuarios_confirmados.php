  ...
  <div class="datagrid" align="Center" style="background:#bb860f;">
            ...
            <h2 align="center"><font FACE="impact" SIZE=6 COLOR=#EFEBEB>Lista de usuarios confirmados</font></h2>
      ...
      <?php
                 $consulta_usuario="SELECT * FROM empleado, perfil WHERE id_estado_empleado='1' and empleado.id_perfil=perfil.id_perfil";
       ...
       <td align="center" colspan="6"><font size="5" FACE="impact" >No se encontrarón resultados</font></td>
        ...
        <td><a title="Eliminar usuarios" href="script_borra_usuario2.php?id_empleado= <?php echo $res_usuarios_obtenidos['id_empleado']; ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
