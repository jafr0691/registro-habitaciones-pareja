    ...
    <div class="gt_sub_banner_bg default_width">
      <div class="container">
        <div class="gt_sub_banner_hdg  default_width">
          <h2>Modulo Listado de Habitaciones en limpieza.</h2>
...
<div class="gt_wrapper">
    ...
    <font size="3" FACE="impact" COLOR=#FFFFFF >Se ha habilitado la habitación <?php echo isset($_GET['numero_habitacion']) ?$_GET['numero_habitacion']:null; ?> de forma exitosa.</font>
               </div>
    <?php } ?>
   
            <?php include "listado_habitaciones_limpieza.php"; ?>
