...
<div class="gt_wrapper">
    <!--Main Content Wrap Start-->
      ...
      <section style="background:#b78b3a">
...
<?php include "filtro_busqueda_reportes.php"; ?>
   
   <div style="position: relative; padding: 10px;  top:-180px; left: 30px;">
            <?php 
            
            include "Listado_reportes_actividades.php"; ?>
