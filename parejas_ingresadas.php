    ...
    <div class="gt_sub_banner_bg default_width">
      <div class="container">
        <div class="gt_sub_banner_hdg  default_width">
          <h2>Modulo Listado de Parejas ingresadas.</h2>
...
<?php 
    ...
    <font size="3" FACE="impact" COLOR=#FFFFFF >Se ingreso la salida de la pareja de la habitación <?php echo isset($_GET['numero_habitacion']) ?$_GET['numero_habitacion']:null; ?> de forma exitosa</font>
               </div>
    <?php } ?>
    

            <?php include "listado_parejas_ingresadas.php"; ?>
