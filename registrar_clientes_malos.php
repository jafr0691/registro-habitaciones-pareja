...
<div class="gt_wrapper">
    ...
    <font size="3" FACE="impact" COLOR=#FFFFFF >Se ha ingresado la placa de forma exitosa.</font>
               </div>
    <?php } ?>
 ...
 <!-- MENSAJE WARNING-->
    ...
    <font size="3" FACE="impact" COLOR=#FFFFFF >Error: No se logro ingresar la placa.</font>
               </div>
    <?php } ?>
...
<?php 
    ...
    <font size="3" FACE="impact" COLOR=#FFFFFF >Alerta: Estas ingresando una placa que ya se encuentra registrada en la base de datos.</font>
               </div>
    <?php } ?>

         <div class="gt_lgin_tab_wrap wow slideInUp">
          <ul class="gt_login_link" data-tabs="tabs">
              <li class="active" align="right"><a data-toggle="tab" style="border-color:#1e1744" >Malos&nbsp;</a></li>
              <li class="active" align="left"><a data-toggle="tab" style="border-color:#1e1744"> Clientes</a></li>
            </ul>
            <?php include "formulario_malos_clientes.php"; ?>
