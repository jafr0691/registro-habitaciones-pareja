...
if(isset($_correo)){
	if(mysqli_num_rows($empleado_ingreso_repetido)>0){
		header("location:login-register.php?status=3");
	}else{
	$sql_insertar_empleado="INSERT INTO empleado SET nombre='$nombre', apellido='$_apellido' ,correo='$_correo', clave='$_password', id_estado_empleado='2' ,id_perfil='$_idperfil'";
