...
<div class="gt_wrapper">
    ...
    <font size="3" FACE="impact" COLOR=#FFFFFF >Se eliminó el registro del usuario <?php echo isset($_GET['nombre']) ?$_GET['nombre']:null; ?> <?php echo isset($_GET['apellido']) ?$_GET['apellido']:null; ?> de forma correcta.</font>
               </div>
    <?php } ?>

   
            <?php include "listado_usuarios_confirmados.php"; ?>
