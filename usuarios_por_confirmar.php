...
<div class="gt_wrapper">
    ...
    <font size="3" FACE="impact" COLOR=#FFFFFF >Se ha aprobado la solicitud de registro del usuario <?php echo isset($_GET['nombre']) ?$_GET['nombre']:null; ?> <?php echo isset($_GET['apellido']) ?$_GET['apellido']:null; ?> de forma exitosa.</font>
               </div>
    <?php } ?>
    ...
    <font size="3" FACE="impact" COLOR=#FFFFFF >Se canceló la solicitud de registro del usuario <?php echo isset($_GET['nombre']) ?$_GET['nombre']:null; ?> <?php echo isset($_GET['apellido']) ?$_GET['apellido']:null; ?> de forma correcta.</font>
               </div>
    <?php } ?>


            <?php include "listado_usuarios_por_confirmar.php"; ?>
