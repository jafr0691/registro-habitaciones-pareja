...
<td colspan="5">
  <br><br> <table border="2">
   ...
   <?php
             $consulta_suma="SELECT timestamp(fecha_de_entrada,hora_de_entrada),timestamp(fecha_salida,hora_salida),
...
<td>
          ...
          <br><br><table  style="float:right">
            ...
            <tr>
              ...
              <td colspan="2"> Firma del Guardia <?php echo $nombresss; ?> <?php echo $apellidoss;  ?> </td>
